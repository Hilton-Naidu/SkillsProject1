...
\begin{enumerate}
\item The 2 most relevant SFIA 9 skills for a cybersecurity specialist working in the industry to protect the safety and privacy of digital systems and data is as follows:
...
\begin{figure}[!h]
\centring
\includegraphics[width=1\textwidth]{skillsD1.png}
\caption{pulling from the git hub}
\includegraphics[width=1\textwidth]{skillsD2.png}
