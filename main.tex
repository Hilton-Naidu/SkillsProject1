...
\begin{minipage}[t]{0.32\textwidth}
\centering
\includegraphics[width=6cm]{jakecommit.png}
\caption*{(a) Commit}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.32\textwidth}
\centering
\includegraphics[width=6cm]{jakecompile1.png}
\caption*{(b) Compile 1}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.32\textwidth}
\centering
\includegraphics[width=6cm]{jakecompile2.png}
\caption*{(c) Compile 2}
\end{minipage}
\caption{My Git and LaTeX workflow}
\end{figure}
\clearpage
