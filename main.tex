...
\begin{enumerate}
    ...
    \item \textbf{Broadcasting and vectorization}: These features let you apply operations to entire arrays at once, without writing complicated loops, making the code faster and cleaner \cite{harris2020}.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Harder for beginners}: Some of the advanced features, like broadcasting, can be confusing if you are new to it \cite{idris2015}.
\end{enumerate}
