...
1. Data analytics (DAAN): Enabling data-driven decision making by extracting, analysing and communicating insights from structured and unstructured data. In the context of this project, DAAN is directly aligned with the requirement to forecast and provide optimal solutions based on historical and real-time disaster data. As a data scientist, the core responsibility is to analyze large datasets, identify patterns, and communicate actionable insights. By leveraging data analytics, I can help decision-makers anticipate future trends, optimize resource allocation, and enhance the effectiveness of emergency response efforts during natural disasters.

2. Data science (DATS): In the context of this project, DATS plays a key role in supporting the data analytics (DAAN) process by applying advanced statistical methods, machine learning, and algorithms to analyze complex disaster-related data. As a data scientist, leveraging DATS techniques allows for deeper insights, predictive modeling, and real-time decision-making that DAAN can use to generate forecasts and optimize responses. DATS helps to build models that predict disaster patterns and behaviors, which are critical for anticipating needs and ensuring effective emergency response strategies. It is essential to DAAN as it provides the foundation for data-driven decision-making.

Working collaboratively has helped me strengthen my technical and professional skills, particularly in applying data science techniques to real-world scenarios. By working with others, I gained a better understanding of how to tackle complex problems and divide tasks effectively. Collaborative discussions helped improve my data analysis approach, and I learned how to communicate findings more clearly. 

During the team project, I identified that the most important skill I need to develop is Data Science (DATS). Throughout the assignment, I faced challenges in applying mathematical solutions to the data, which made forecasting particularly difficult. To address this, I plan to improve my mathematical skills and focus on solving data-related problems to enhance my ability to analyze and forecast effectively. Strengthening this skill will enable me to make better data-driven decisions and improve my overall performance in future data science projects.
