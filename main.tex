...
\begin{enumerate}
    \item \textbf{Multi-dimensional arrays}: NumPy makes it easy to create and work with arrays that have many rows and columns, much faster than regular Python lists \cite{harris2020}.
    \item \textbf{Math operations}: It provides built-in ways to quickly do calculations like adding, multiplying, finding averages, or working with matrices \cite{harris2020}.
...
\begin{enumerate}
    \item \textbf{High memory use}: It can use a lot of memory when working with very large datasets, which can slow things down \cite{idris2015}.
